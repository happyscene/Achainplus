...
#define SET_APP_HANDLER( receiver, contract, action) \
   ...
   SET_APP_HANDLER( actx, actx, newaccount );
   SET_APP_HANDLER( actx, actx, setcode );
   SET_APP_HANDLER( actx, actx, setabi );
   SET_APP_HANDLER( actx, actx, updateauth );
   SET_APP_HANDLER( actx, actx, deleteauth );
   SET_APP_HANDLER( actx, actx, linkauth );
   SET_APP_HANDLER( actx, actx, unlinkauth );
/*
